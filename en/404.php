                    ...
                    <div class="modal-content">
                        ...
                        ?>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-flat btn-submit-nova-ocorrencia">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form class="form-nova-nota">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default btn-flat pull-left closed" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-primary btn-flat btn-submit-nova-nota">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        <form class="form-novo-tecnico">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-flat btn-submit-novo-tecnico">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
