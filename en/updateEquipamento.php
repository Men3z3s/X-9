                ...
                $ret = $sql->rowCount();
                    ...
                    if($ret > 0) {
                        ...
                        $py = md5('idequipamento');
                            ...
                            if($lin->mostra == 'F') {
                                die('This equipment is already registered, but is disabled. <a href="activateEquipamento.php?'.$py.'='.$lin->idequipamento.'" title="Ativar o cadastro do equipamento">Clique para ativar.</a>');    
                            }
                    }
