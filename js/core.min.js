...
$(document).ready(function () {
    ...
    $(".delete-tecnico").click(function (e) {
        var click = this.id.split('-'), py = click[0], id = click[1];
        e.preventDefault();

        $.smkConfirm({
            text:'Quer mesmo excluir o técnico?',
            accept:'Sim',
            cancel:'Não'
        },function (res) {
            // Code here
            if(res) {
                location.href = 'deleteTecnico.php?' + py + '=' + id;
            }
        });
    });
    ...
    $(".form-nova-nota").submit(function (e) {
        e.preventDefault();

	    $.post("insertNota.php", { datado: $("#datado-nota").val(), tecnico: $("#tecnico-nota").val(), texto: $("#texto").val(), rand: Math.random()}, function (data) {
            $(".btn-submit-nova-nota").html('<img src="img/rings.svg" class="loader-svg">').fadeTo(fade, 1);

            switch (data) {
            case 'true':
                $.smkAlert({text: 'Nota cadastrada com sucesso.', type: 'success', time: 2});
                //window.setTimeout("location.href='autor'", delay);
                $(".form-nova-nota")[0].reset();
                break;
            ...
            $(".btn-submit-nova-nota").html('Salvar').fadeTo(fade, 1);
        });
    ...
    $(".form-nova-ocorrencia").submit(function (e) {
        e.preventDefault();

	    $.post("insertOcorrencia.php", { serial: $("#serial").val(), stamp: $("#stamp").val(), cliente: $("#cliente").val(), datado: $("#datado").val(), hora: $("#hora").val(), tecnico: $("#tecnico").val(), solicitacao: $("#solicitacao").val(), diagnostico: $("#diagnostico").val(), procedimento: $("#procedimento").val(), observacao: $("#observacao").val(), entrega: $("input[name='entrega']:checked").val(), fechada: $("input[name='fechada']:checked").val(), retorno: $("input[name='retorno']:checked").val(), viacliente: $("input[name='viacliente']:checked").val(), rand: Math.random()}, function (data) {
            $(".btn-submit-nova-ocorrencia").html('<img src="img/rings.svg" class="loader-svg">').fadeTo(fade, 1);

            if (data === 'true') {
                $.smkAlert({text: 'Ocorr&ecirc;ncia cadastrada com sucesso.', type: 'success', time: 2});
            ...
            $(".btn-submit-nova-ocorrencia").html('Salvar').fadeTo(fade, 1);
        });
    ...
    $(".form-novo-item").submit(function (e) {
        e.preventDefault();

	    $.post("insertItem.php", { idocorrencia: $("#idocorrencia").val(), descricao: $("#descricao").val(), valor: $("#valor").val(), quantidade: $("#quantidade").val(), desconto: $("#desconto").val(), subtotal: $("#subtotal").val(), rand: Math.random()}, function (data) {
            ...
            case 'reload':
                ...
                break;
            case 'true':
                $.smkAlert({text: 'Item cadastrado com sucesso.', type: 'success', time: 2});
                $(".form-novo-item")[0].reset();
                break;
            ...
            $(".btn-submit-novo-item").html('Salvar').fadeTo(fade, 1);
        });
    ...
    $(".delete-item").click(function (e) {
        var click = this.id.split('-'), pyconta = click[0], idconta = click[1], pyoc = click[2], idoc = click[3], pyserial = click[4], serial = click[5];
        e.preventDefault();

        $.smkConfirm({
            text:'Quer mesmo excluir a item?',
            accept:'Sim',
            cancel:'Não'
        },function (res) {
            // Code here
            if(res) {
                location.href = 'deleteItem.php?' + pyconta + '=' + idconta + '&' + pyoc + '=' + idoc + '&' + pyserial + '=' + serial;
            }
        });
    });
    ...
    $(".form-novo-recibo").submit(function (e) {
        e.preventDefault();

	    $.post("insertRecibo.php", { hora: $("#hora-recibo").val(), cliente: $("#cliente-recibo").val(), serial: $("#serial-recibo").val(), datado: $("#datado-recibo").val(), valor: $("#valor").val(), receptor: $("#receptor").val(), rand: Math.random()}, function (data) {
            $(".btn-submit-novo-recibo").html('<img src="img/rings.svg" class="loader-svg">').fadeTo(fade, 1);

            if (data.match(/<url>/g)) {
                $.smkAlert({text: 'Recibo cadastrado com sucesso.', type: 'success', time: 2});
                data = data.replace("<url>","");
                data = data.replace("</url>","");
                window.setTimeout("location.href='" + data + "'", delay);
            }
            ...
            $(".btn-submit-novo-recibo").html('Salvar').fadeTo(fade, 1);
        });
    ...
    $(".delete-recibo").click(function (e) {
        var click = this.id.split('-'), py = click[0], id = click[1];
        e.preventDefault();

        $.smkConfirm({
            text:'Quer mesmo excluir o recibo?',
            accept:'Sim',
            cancel:'Não'
        },function (res) {
            // Code here
            if(res) {
                location.href = 'deleteRecibo.php?' + py + '=' + id;
            }
        });
    });
    ...
    $(".form-novo-cliente").submit(function (e) {
	    ...
	    $.post("insertCliente.php", { nome: $("#nome-cliente").val(), nascimento: $("#nascimento").val(), documento: documento, documento2: documento2, telefone: $("#telefone").val(), celular: $("#celular").val(), email: $("#email").val(), cep: $("#cep").val(), endereco: $("#endereco").val(), bairro: $("#bairro").val(), cidade: $("#cidade").val(), estado: $("#estado").val(), observacao: $("#observacao-cliente").val(), rand: Math.random()}, function (data) {
            ...
            $(".btn-submit-novo-cliente").html('Salvar').fadeTo(fade, 1);
        });
    ...
    $(".delete-cliente").click(function (e) {
        ...
        $.smkConfirm({
            text:'Quer mesmo excluir o cliente?',
            accept:'Sim',
            cancel:'Não'
        },function (res) {
            // Code here
            if(res) {
                location.href = 'deleteCliente.php?' + py + '=' + id;
            }
        });
    });
