...
oPaginate:{sFirst:"Primeiro",sLast:"&Uacute;ltimo",sNext:"<i class='fa fa-arrow-right'></i>",sPrevious:"<i class='fa fa-arrow-left'></i>"},sEmptyTable:"Dado n&atilde;o dispon&iacute;vel na tabela",sInfo:"Mostrando _START_ at&eacute; _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 at&eacute; 0 de 0 entries",sInfoFiltered:"(filtrado de _MAX_ registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registros",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"Filtro:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum registro encontrado"},oSearch:h.extend({},
