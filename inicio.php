<?php
    require_once('config.php');
        ...
        if(empty($_SESSION['key'])) {
            ...
            if(base64_decode($_SESSION['key']) == 'saude'){
                header ('location:inicioSaude.php');
            }
        }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>In&iacute;cio <span class="pull-right lead"><a data-toggle="modal" data-target="#nova-ocorrencia" title="Clique para abrir uma nova ocorr&ecirc;ncia" href="#"><i class="fa fa-file-text"></i> Nova ocorr&ecirc;ncia</a></span></h1>
                </section>
